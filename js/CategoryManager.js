...
// FIXED: Prevents duplicate declarations and ensures proper loading
...
if (typeof module !== 'undefined' && module.exports) {
    ...
    console.log('⚠️ CategoryManager already exists, skipping redeclaration');
}
    constructor() {
        this.config = null;
        this.loaded = false;
...
// CRITICAL FIX: Create global instance immediately when script loads
console.log('🔧 Creating CategoryManager instance...');
const categoryManager = new CategoryManager();
console.log('✅ CategoryManager instance created:', typeof categoryManager);
